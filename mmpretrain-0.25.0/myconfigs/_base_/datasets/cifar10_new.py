# 2.220服务器相对地址
# root = '/yds/code/DataDownload/classification/data/datasets2mmcls/cifar_10_20211007/'

# V100服务器相对地址
# root = '/home/sr/datasets/DataDownload-master/classification/data/datasets2mmcls/caltech_101_20211007/'

root = '/jindofs_temp/nas/mnt/yindongshuo.yds/data/datasets2mmcls/cifar_10_20211007/'

# dataset settings
dataset_type = 'CIFAR10N'
img_norm_cfg = dict(
